...
The following plot shows a reduced extract of Fanel's land use area. Iit can be concluded that the suitable schreck WSS_2016_01 is located on the grassland area No.2 (German: Wiese Nr. 2). Grassland areas are optimal for our research question, since wild boars spoil the ground during their search for food.
```{r, echo = FALSE, warning=FALSE, message=FALSE}
# Visualization
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Caroline"}
# Caroline 
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Miriam"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Frida"}
