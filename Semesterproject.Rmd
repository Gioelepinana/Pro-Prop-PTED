...
Within this semester project, two methods are analyzed in order to determine the effectiveness of the scare method and their strengths and weaknesses are compared. Therefore we work with following introduced datasets:
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Temporal overlap from 19 wild boar in the region Fenel"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Mean Distance to WSS_2016_01 Caroline, Miriam and Frida "}
