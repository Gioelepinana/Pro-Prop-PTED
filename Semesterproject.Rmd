...
<br><br>
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="test"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="test2"}
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="test3"}
...
```{r}
# Option 1: Mit facet_wrap()
bind_rows(Frida,Miriam, Caroline) %>%
  ggplot() +
...
# mit out.width="30%" (bei 3 Bilder) oder "49%"(bei zwei bilder) und option fig.show = "hold"
